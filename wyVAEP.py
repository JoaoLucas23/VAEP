...
class wyVAEP(d6t.tasks.TaskCSVPandas):
    ...
    def requires(self):
        return ComputeVAEP(competition_name=self.competition_name, train_competitions=selected_competitions, num_prev_actions=self.num_prev_actions), WyscoutToSPADL(competition_name=self.competition_name)
